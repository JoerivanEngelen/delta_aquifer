...
clip1.Scalars = ['CELLS', 'conc1']
clip1.Value = -4971.368032455444
...
# create a new 'Clip'
clip2 = Clip(Input=transform2)
clip2.ClipType = 'Plane'
clip2.Scalars = ['CELLS', 'river']
clip2.Value = -4971.368032455444
clip2.ClipType.Origin = [100.0, -1000.0, 1.0]
...
# create a new 'Threshold'
threshold2 = Threshold(Input=clip2)
...
threshold3 = Threshold(Input=clip2)
